...
class FacebookLikesWidget extends WP_Widget
{
	function FacebookLikesWidget()
	{
		$widget_settings = array(
			'description' => 'Facebook Likes Widget',
			'classname' => 'widgets-facebook-likes'
		);
	...
	function widget($args, $instance)
	{
		...
		echo $application_id; ?>&version=v2.0";
	...
	function form($instance)
	{
		$instance = wp_parse_args((array)$instance, array(
			...
			'application_id' => '544929572223180'
		));
...
?>
		...
		<p>
		<label for="<?php
		echo $this->get_field_id('application_id'); ?>">Application Id:</label>
		<input class="widefat" id="<?php
		echo $this->get_field_id('application_id'); ?>" name="<?php
		echo $this->get_field_name('application_id'); ?>" type="text" value="<?php
		echo $application_id; ?>" />
		</p>
<?php
	}
