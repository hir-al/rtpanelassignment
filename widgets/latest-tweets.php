...
class LatestTweetsWidget extends WP_Widget
{
    function LatestTweetsWidget(){
		$widget_settings = array('description' => 'Display Latest Tweets Widget', 'classname' => 'widgets-latest-tweets');
    ...
    function widget($args, $instance){
		...
		require_once( get_template_directory() . '/twitteroauth/twitteroauth.php'); // grab twitteroauth from correct place
    ...
    function form($instance){
		$instance = wp_parse_args( (array) $instance, array('title'=>'Latest Tweets', 'screen_name'=>'heer716', 'number_of_tweets' => '5') );	
...
<p>
  ...
  <input class="widefat" id="<?php echo $this->get_field_id('number_of_tweets');?>" name="<?php echo $this->get_field_name('number_of_tweets');?>" type="text" value="<?php echo $number_of_tweets;?>" />
</p>
<?php
	}
}
