...
// Widget to display static links with redirect url
...
class FooterLinksWidget extends WP_Widget
{
	function FooterLinksWidget()
	{
		$widget_settings = array(
			'description' => 'List of Links Widget',
			'classname' => 'widgets-links'
		);
...
?>
		<p><label for="<?php
		echo $this->get_field_id('title'); ?>">Title:</label><input class="widefat" id="<?php
		echo $this->get_field_id('title'); ?>" name="<?php
		echo $this->get_field_name('title'); ?>" type="text" value="<?php
		echo $title; ?>" /></p>		
		<p><label for="<?php
		echo $this->get_field_id('link1'); ?>">Link1:</label><textarea cols="18" rows="3" class="widefat" id="<?php
		echo $this->get_field_id('link1'); ?>" name="<?php
		echo $this->get_field_name('link1'); ?>" ><?php
		echo $link1; ?></textarea></p>
		<p><label for="<?php
		echo $this->get_field_id('linkURL1'); ?>">Link URL1:<br /></label>
		<input class="widefat" id="<?php
		echo $this->get_field_id('linkURL1'); ?>" name="<?php
		echo $this->get_field_name('linkURL1'); ?>" type="text" value="<?php
		echo $linkURL1; ?>" />
		<label>(e.g. http://www.Google.com/...)</label><br />
		<p><label for="<?php
		echo $this->get_field_id('link2'); ?>">Link2:</label><textarea cols="18" rows="3" class="widefat" id="<?php
		echo $this->get_field_id('link2'); ?>" name="<?php
		echo $this->get_field_name('link2'); ?>" ><?php
		echo $link2; ?></textarea></p>
		<p><label for="<?php
		echo $this->get_field_id('linkURL2'); ?>">Link URL2:<br /></label>
		<input class="widefat" id="<?php
		echo $this->get_field_id('linkURL2'); ?>" name="<?php
		echo $this->get_field_name('linkURL2'); ?>" type="text" value="<?php
		echo $linkURL2; ?>" />
		<label>(e.g. http://www.Google.com/...)</label><br />
		<p><label for="<?php
		echo $this->get_field_id('link3'); ?>">Link3:</label><textarea cols="18" rows="3" class="widefat" id="<?php
		echo $this->get_field_id('link3'); ?>" name="<?php
		echo $this->get_field_name('link3'); ?>" ><?php
		echo $link3; ?></textarea></p>
		<p><label for="<?php
		echo $this->get_field_id('linkURL3'); ?>">Link URL3:<br /></label>
		<input class="widefat" id="<?php
		echo $this->get_field_id('linkURL3'); ?>" name="<?php
		echo $this->get_field_name('linkURL3'); ?>" type="text" value="<?php
		echo $linkURL3; ?>" />
		<label>(e.g. http://www.Google.com/...)</label><br />
		<p><label for="<?php
		echo $this->get_field_id('link4'); ?>">Link4:</label><textarea cols="18" rows="3" class="widefat" id="<?php
		echo $this->get_field_id('link4'); ?>" name="<?php
		echo $this->get_field_name('link4'); ?>" ><?php
		echo $link4; ?></textarea></p>
		<p><label for="<?php
		echo $this->get_field_id('linkURL4'); ?>">Link URL4:<br /></label>
		<input class="widefat" id="<?php
		echo $this->get_field_id('linkURL4'); ?>" name="<?php
		echo $this->get_field_name('linkURL4'); ?>" type="text" value="<?php
		echo $linkURL4; ?>" />
		<label>(e.g. http://www.Google.com/...)</label>	
		
		<p><label for="<?php
		echo $this->get_field_id('link5'); ?>">Link5:</label><textarea cols="18" rows="3" class="widefat" id="<?php
		echo $this->get_field_id('link5'); ?>" name="<?php
		echo $this->get_field_name('link5'); ?>" ><?php
		echo $link5; ?></textarea></p>
		<p><label for="<?php
		echo $this->get_field_id('linkURL5'); ?>">Link URL5:<br /></label>
		<input class="widefat" id="<?php
		echo $this->get_field_id('linkURL5'); ?>" name="<?php
		echo $this->get_field_name('linkURL5'); ?>" type="text" value="<?php
		echo $linkURL5; ?>" />
		<label>(e.g. http://www.Google.com/...)</label>			
		<?php
	}
