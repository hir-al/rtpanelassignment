...
// Widget to display Wordpress pages list
...
class WordpressPagesWidget extends WP_Widget
{
	function WordpressPagesWidget()
	{
		$widget_settings = array(
			'description' => 'Display Pages List Widget',
			'classname' => 'widgets-pages'
		);
...
<p>
	...
	<textarea cols="18" rows="3" class="widefat" id="<?php
		echo $this->get_field_id('pages'); ?>" name="<?php
		echo $this->get_field_name('pages'); ?>" ><?php
		echo $pages; ?></textarea>
</p>
<?php
	}
